...
if($user_action=="edit"){
  if(!isset($_POST["id"]) || $_POST["id"]==null){
    header("Location: error.php?msg=Customer ID is missing.");
  }

  $query = "update client set cl_username=".singleQuote($_POST["input_usrname"]).",cl_password=".singleQuote($_POST["input_password"]).",cl_firstname=".singleQuote($_POST["input_fname"]).",
  cl_lastname=".singleQuote($_POST["input_lname"]).",cl_mobile=".singleQuote($_POST["input_mobile"]).",cl_email=".singleQuote($_POST["input_email"]).",
  cl_address=".singleQuote($_POST["input_address"]).",cl_suburb=".singleQuote($_POST["input_suburb"]).",cl_city=".singleQuote($_POST["input_city"]).", 
  cl_state=".singleQuote($_POST["input_state"]).",cl_date=".singleQuote($date)."where cl_id=".singleQuote($_POST["id"]);

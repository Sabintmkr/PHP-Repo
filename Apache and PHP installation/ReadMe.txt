1. Install apache24 in c drive as written below
2. copy the conf folder from system required folder and replace in apache24 folder
3. from system required folder uzip php7 and paste it in program files 
4. paste the php files in htdocs
5. localhost:8081 port
6. run from VS Code ./httpd.exe

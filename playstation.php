...
<div class="row">
  ...
  <div class="img-body">
            ...
            <div class="text game-heading"><h1>Coming Soon!!!</h1></div>
            </div>

            <div class="imgslides fade">
            <div class="numbering">2 / 3</div>
            <img src="images/fifa.png" style="width:100%">
            <div class="text game-heading"><h1>Pre Order NOW!!!!</h1></div>
            </div>

            <div class="imgslides fade">
            <div class="numbering">3 / 3</div>
            <img src="images/thelast.jpg" style="width:100%">
            <div class="text game-heading"><h1>Release on Aug 14th. GRAB YOUR COPY</h1></div>
            </div>
    ...
    <?php
      if(!empty($p_list)){
          foreach($p_list as $list){ 
            if($list['p_category'] == 'PlayStation'){?>
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100">
            <a href="product.php?id=<?= $list['p_id'];?>"><img src="<?=htmlspecialchars_decode($list['p_image']);?>" alt="<?=htmlspecialchars_decode($list['p_name']);?>" style="width: 100%;"/></a>

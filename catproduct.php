...
if(isset($_GET["id"])){
  ...
  $c_list = getCategory($id);
      
  $cplatform = $c_list['cat_platform'];
                      ...
                      foreach($p_list as $list){ 
                        if($list['p_category'] == $cplatform){?>
                            ...
                            <?php
                              if($list['p_sale'] == "Yes"){
                            ?>
                            <p class="card-text" style="color: red; font-weight: 800; font-size: -webkit-xxx-large;">
                                Sale</p>
                            <?php }?>
                        </div>
